...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  if (type === 'pageview') {
    ...
    await Object(lib_queries__WEBPACK_IMPORTED_MODULE_2__[/* savePageView */ "v"])(website_id, session_id, url, referrer);
  } else if (type === 'event') {
    const {
      url,
      event_type,
    ...
    await Object(lib_queries__WEBPACK_IMPORTED_MODULE_2__[/* saveEvent */ "u"])(website_id, session_id, url, event_type, event_value);
  } else {
