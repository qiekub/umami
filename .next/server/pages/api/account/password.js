...
__webpack_require__.d(__webpack_exports__, "x", function() { return /* binding */ updateWebsite; });
...
__webpack_require__.d(__webpack_exports__, "v", function() { return /* binding */ savePageView; });
__webpack_require__.d(__webpack_exports__, "u", function() { return /* binding */ saveEvent; });
...
__webpack_require__.d(__webpack_exports__, "w", function() { return /* binding */ updateAccount; });
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    const valid = await Object(lib_crypto__WEBPACK_IMPORTED_MODULE_3__[/* checkPassword */ "a"])(current_password, account.password);

    if (!valid) {
      return Object(lib_response__WEBPACK_IMPORTED_MODULE_2__[/* badRequest */ "a"])(res, 'Current password is incorrect');
    }

    const password = await Object(lib_crypto__WEBPACK_IMPORTED_MODULE_3__[/* hashPassword */ "e"])(new_password);
    const updated = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* updateAccount */ "w"])(user_id, {
      password
    });
