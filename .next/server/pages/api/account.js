  ...
  if (req.method === 'POST') {
    ...
    if (user_id) {
      ...
      if (account.user_id === current_user_id || current_user_is_admin) {
        ...
        if (password) {
          data.password = await Object(lib_crypto__WEBPACK_IMPORTED_MODULE_2__[/* hashPassword */ "e"])(password);
        ...
        const updated = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* updateAccount */ "w"])(user_id, data);
      ...
      const created = await Object(lib_queries__WEBPACK_IMPORTED_MODULE_0__[/* createAccount */ "a"])({
        username,
        password: await Object(lib_crypto__WEBPACK_IMPORTED_MODULE_2__[/* hashPassword */ "e"])(password)
      });
